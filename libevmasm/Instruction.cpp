...
const std::map<std::string, Instruction> dev::solidity::c_instructions =
	{
		...
		{"CALLASSETID", Instruction::CALLASSETID},
		...
		{"CALLEX", Instruction::CALLEX},
		{"CALLWITHPAY", Instruction::CALLWITHPAY},
		{"EXTCOUNT", Instruction::EXTCOUNT},
		{"EXTASSETID1", Instruction::EXTASSETID1},
		{"EXTVALUE1", Instruction::EXTVALUE1},
		{"EXTASSETID2", Instruction::EXTASSETID2},
		{"EXTVALUE2", Instruction::EXTVALUE2},
		{"EXTASSETID3", Instruction::EXTASSETID3},
		{"EXTVALUE3", Instruction::EXTVALUE3},
		{"EXTASSETID4", Instruction::EXTASSETID4},
		{"EXTVALUE4", Instruction::EXTVALUE4},
		{"EXTASSETID5", Instruction::EXTASSETID5},
		{"EXTVALUE5", Instruction::EXTVALUE5},
		{"EXTASSETID6", Instruction::EXTASSETID6},
		{"EXTVALUE6", Instruction::EXTVALUE6},
		{"EXTASSETID7", Instruction::EXTASSETID7},
		{"EXTVALUE7", Instruction::EXTVALUE7},
		{"EXTASSETID8", Instruction::EXTASSETID8},
		{"EXTVALUE8", Instruction::EXTVALUE8},
		{"CALLCODE", Instruction::CALLCODE},
		{"ADDASSET", Instruction::ADDASSET},
		{"ISSUEASSET", Instruction::ISSUEASSET},
		{"SETASSETOWNER", Instruction::SETASSETOWNER},
		{"BALANCEEX", Instruction::BALANCEEX},
		{"SNAPBALANCE", Instruction::SNAPBALANCE},
		{"DESTROYASSET", Instruction::DESTROYASSET},
		{"GETACCOUNTID", Instruction::GETACCOUNTID},
		{"GETDELEGATE", Instruction::GETDELEGATE},
		{"GETACCOUNTTIME", Instruction::GETACCOUNTTIME},
		{"CRYPTOCALC", Instruction::CRYPTOCALC},
		{"DEDUCTGAS", Instruction::DEDUCTGAS},
		{"WITHDRAWFEE", Instruction::WITHDRAWFEE},
		{"ASSETINFO", Instruction::ASSETINFO},
		{"GETEPOCH", Instruction::GETEPOCH},
		{"GETCANDIDATENUM", Instruction::GETCANDIDATENUM},
		{"GETCANDIDATE", Instruction::GETCANDIDATE},
		{"GETVOTERSTAKE", Instruction::GETVOTERSTAKE},
		{"GETASSETID", Instruction::GETASSETID},
		{"RECIPIENT", Instruction::RECIPIENT},
		{"SNAPSHOTTIME", Instruction::SNAPSHOTTIME},
...
static const std::map<Instruction, InstructionInfo> c_instructionInfo =
	{ //												Add, Args, Ret, SideEffects, GasPriceTier
		...
		{Instruction::RECIPIENT, {"RECIPIENT", 0, 0, 1, false, Tier::Base}},
		{Instruction::CALLER, {"CALLER", 0, 0, 1, false, Tier::Base}},
		{Instruction::CALLVALUE, {"CALLVALUE", 0, 0, 1, false, Tier::Base}},
		{Instruction::CALLASSETID, {"CALLASSETID", 0, 0, 1, false, Tier::Base}},
		...
		{Instruction::CALLEX, {"CALLEX", 0, 8, 1, true, Tier::Special}},
		{Instruction::CALLWITHPAY, {"CALLWITHPAY", 0, 8, 1, true, Tier::Special}},
		{Instruction::EXTCOUNT, {"EXTCOUNT", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTASSETID1, {"EXTASSETID1", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTVALUE1, {"EXTVALUE1", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTASSETID2, {"EXTASSETID2", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTVALUE2, {"EXTVALUE2", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTASSETID3, {"EXTASSETID3", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTVALUE3, {"EXTVALUE3", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTASSETID4, {"EXTASSETID4", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTVALUE4, {"EXTVALUE4", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTASSETID5, {"EXTASSETID5", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTVALUE5, {"EXTVALUE5", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTASSETID6, {"EXTASSETID6", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTVALUE6, {"EXTVALUE6", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTASSETID7, {"EXTASSETID7", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTVALUE7, {"EXTVALUE7", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTASSETID8, {"EXTASSETID8", 0, 0, 1, false, Tier::Base}},
		{Instruction::EXTVALUE8, {"EXTVALUE8", 0, 0, 1, false, Tier::Base}},
		{Instruction::CALLCODE, {"CALLCODE", 0, 7, 1, true, Tier::Special}},
		{Instruction::RETURN, {"RETURN", 0, 2, 0, true, Tier::Zero}},
		{Instruction::DELEGATECALL, {"DELEGATECALL", 0, 6, 1, true, Tier::Special}},
		{Instruction::ADDASSET, {"ADDASSET", 0, 3, 1, true, Tier::Special}},
		{Instruction::ISSUEASSET, {"ISSUEASSET", 0, 2, 1, true, Tier::Special}},
		{Instruction::SETASSETOWNER, {"SETASSETOWNER", 0, 2, 1, true, Tier::Special}},
		{Instruction::BALANCEEX, {"BALANCEEX", 0, 2, 1, true, Tier::Special}},
		{Instruction::SNAPBALANCE, {"SNAPBALANCE", 0, 4, 1, true, Tier::Special}},
		{Instruction::ASSETINFO, {"ASSETINFO", 0, 4, 2, true, Tier::Special}},
		{Instruction::SNAPSHOTTIME, {"SNAPSHOTTIME", 0, 2, 1, true, Tier::Special}},
		{Instruction::DESTROYASSET, {"DESTROYASSET", 0, 2, 1, true, Tier::Special}},
		{Instruction::GETACCOUNTID, {"GETACCOUNTID", 0, 2, 1, true, Tier::Special}},
		{Instruction::GETASSETID, {"GETASSETID", 0, 2, 1, true, Tier::Special}},
		{Instruction::GETDELEGATE, {"GETDELEGATE", 0, 2, 3, true, Tier::Special}},
		{Instruction::GETACCOUNTTIME, {"GETACCOUNTTIME", 0, 1, 1, true, Tier::Special}},
		{Instruction::DEDUCTGAS, {"DEDUCTGAS", 0, 1, 1, true, Tier::Special}},
		{Instruction::WITHDRAWFEE, {"WITHDRAWFEE", 0, 2, 1, true, Tier::Special}},
		{Instruction::CRYPTOCALC, {"CRYPTOCALC", 0, 7, 1, true, Tier::Special}},
		{Instruction::GETEPOCH, {"GETEPOCH", 0, 2, 2, true, Tier::Special}},
		{Instruction::GETCANDIDATENUM, {"GETCANDIDATENUM", 0, 1, 1, true, Tier::Special}},
		{Instruction::GETCANDIDATE, {"GETCANDIDATE", 0, 2, 7, true, Tier::Special}},
		{Instruction::GETVOTERSTAKE, {"GETVOTERSTAKE", 0, 3, 1, true, Tier::Special}},
