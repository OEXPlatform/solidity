...
IntegerType::IntegerType(unsigned _bits, IntegerType::Modifier _modifier) : m_bits(_bits), m_modifier(_modifier)
{
	if (isAddress())
...
FixedPointType::FixedPointType(unsigned _totalBits, unsigned _fractionalDigits, FixedPointType::Modifier _modifier) : m_totalBits(_totalBits), m_fractionalDigits(_fractionalDigits), m_modifier(_modifier)
{
	solAssert(
...
shared_ptr<FixedPointType const> RationalNumberType::fixedPointType() const
{
	...
	rational maxValue = negative ? rational(bigint(1) << 255, 1) : rational((bigint(1) << 256) - 1, 1);
...
FunctionType::FunctionType(FunctionDefinition const &_function, bool _isInternal) : m_kind(_isInternal ? Kind::Internal : Kind::External),
...
FunctionType::FunctionType(VariableDeclaration const &_varDecl) : m_kind(Kind::External),
...
FunctionType::FunctionType(EventDefinition const &_event) : m_kind(Kind::Event),
															m_stateMutability(StateMutability::NonPayable),
...
FunctionType::FunctionType(FunctionTypeName const &_typeName) : m_kind(_typeName.visibility() == VariableDeclaration::Visibility::External ? Kind::External : Kind::Internal),
...
string FunctionType::richIdentifier() const
{
	...
	case Kind::AddAsset:
		id += "addasset";
		break;
	case Kind::IssueAsset:
		id += "issueasset";
		break;
	case Kind::SetAssetOwner:
		id += "setassetowner";
		break;
	case Kind::BalanceEx:
		id += "balanceex";
		break;
	case Kind::WithdrawFee:
		id += "withdrawfee";
		break;
	case Kind::AssetInfo:
		id += "assetinfo";
		break;
	case Kind::SnapBalance:
		id += "snapbalance";
		break;
	case Kind::SHA3:
		id += "sha3";
...
MemberList::MemberMap MagicType::nativeMembers(ContractDefinition const *) const
{
	...
	{
	case Kind::Block:
		return MemberList::MemberMap({{"coinbase", make_shared<IntegerType>(160, IntegerType::Modifier::Address)},
	...
	case Kind::Message:
		return MemberList::MemberMap({{"sender", make_shared<IntegerType>(160, IntegerType::Modifier::Address)},
									  ...
									  {"extvalue2", make_shared<IntegerType>(256)},
									  {"extassetid3", make_shared<IntegerType>(256)},
									  {"extvalue3", make_shared<IntegerType>(256)},
									  {"extassetid4", make_shared<IntegerType>(256)},
									  {"extvalue4", make_shared<IntegerType>(256)},
									  {"extassetid5", make_shared<IntegerType>(256)},
									  {"extvalue5", make_shared<IntegerType>(256)},
									  {"extassetid6", make_shared<IntegerType>(256)},
									  {"extvalue6", make_shared<IntegerType>(256)},
									  {"extassetid7", make_shared<IntegerType>(256)},
									  {"extvalue7", make_shared<IntegerType>(256)},
									  {"extassetid8", make_shared<IntegerType>(256)},
									  {"extvalue8", make_shared<IntegerType>(256)},
									  {"data", make_shared<ArrayType>(DataLocation::CallData)},
									  {"sig", make_shared<FixedBytesType>(4)}});
	case Kind::Transaction:
		return MemberList::MemberMap({{"origin", make_shared<IntegerType>(160, IntegerType::Modifier::Address)},
									  {"recipient", make_shared<IntegerType>(160, IntegerType::Modifier::Address)},
									  {"gasprice", make_shared<IntegerType>(256)}});
	case Kind::ABI:
		return MemberList::MemberMap({{"encode", make_shared<FunctionType>(
													 TypePointers(),
